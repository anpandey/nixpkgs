...
let
  # fakeredis = python3.pkgs.fakeredis.overridePythonAttrs (old: rec {
  #   version = "0.16.0";
  #   src = fetchPypi {
  #     pname = "fakeredis";
  #     inherit version;
  ...
  python = python3.override {
    packageOverrides = self: super: {
      # Necessary for older versions of Jinja2 to function.
      ...
      # Jinja2 3.0 and later is backwards-incompatible and breaks pywb entirely.
      jinja2 = python3.pkgs.jinja2.overridePythonAttrs (old: rec {
        version = "2.11.3";
        src = old.src.override {
          inherit version;
      ...
      # This is a necessary for the overridden version of Jinja2.
